...
require_once __DIR__ . '/../../includes/models/UnifiedSlotTracker.php';
...
function handleAddComponent($serverBuilder, $user) {
    ...
    try {
        ...
        // SFP Port Validation
        if ($componentType === 'sfp') {
            require_once __DIR__ . '/../../includes/models/NICPortTracker.php';
                ...
                try {
                    ...
                    if ($configData && !empty($configData['sfp_configuration'])) {
                        ...
                        if (!empty($unassignedSfps)) {
                            ...
                            require_once __DIR__ . '/../../includes/models/SFPCompatibilityResolver.php';
