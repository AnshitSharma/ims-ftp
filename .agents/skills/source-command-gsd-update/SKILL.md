---
name: "source-command-gsd-update"
description: "Update GSD to latest version with changelog display"
---

# source-command-gsd-update

Use this skill when the user asks to run the migrated source command `gsd-update`.
...
- `./.Codex/commands/gsd/` will be wiped and replaced
- `./.Codex/get-shit-done/` will be wiped and replaced
- `./.Codex/agents/gsd-*` files will be replaced

Your custom files in other locations are preserved:
- Custom commands in `./.Codex/commands/your-stuff/` ✓
...
⚠️  Restart Codex to pick up the new commands.
