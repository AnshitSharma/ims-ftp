---
name: "source-command-gsd-help"
description: "Show available GSD commands and usage guide"
---

# source-command-gsd-help

Use this skill when the user asks to run the migrated source command `gsd-help`.
...
**GSD** (Get Shit Done) creates hierarchical project plans optimized for solo agentic development with Codex.
