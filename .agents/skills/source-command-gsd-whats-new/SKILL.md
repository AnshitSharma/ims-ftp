---
name: "source-command-gsd-whats-new"
description: "See what's new in GSD since your installed version"
---

# source-command-gsd-whats-new

Use this skill when the user asks to run the migrated source command `gsd-whats-new`.
...
```bash
cat ./.Codex/get-shit-done/CHANGELOG.md 2>/dev/null
```
